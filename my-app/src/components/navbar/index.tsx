...
const Navbar: React.FC = () => {
  ...
  return (
    <div className={`fixed w-full bg-white z-999 text-black shadow-lg transition-transform transform
    ${showNav ? 'translate-y-0' : '-translate-y-full'} h-[80px] md:h-[100px] flex justify-between items-center`}>
      ...
      <div className='hidden lg:block w-[80%] h-full'>
        <div className='bg-neutral-100 h-1/2 flex items-center'>
          ...
          <div className='w-1/4 h-full flex justify-end'>
            <div className='w-1/2 h-full flex justify-around items-center'>
              <div><FaFacebook /></div><span>|</span>
              <div><FaTwitter /></div><span>|</span>
              <div><FaLinkedin /></div>
            </div>
          </div>
        </div>
      ...
      <div className='hidden lg:hidden md:grid content-center w-[40%] h-full text-xl
                      font-bold hover:underline underline-offset-8 cursor-pointer bg-neutral-200'>
        TRANSPORTATION AGENCY
      </div>
      <div className='hidden md:block lg:hidden w-[60%] h-full text-sm bg-neutral-100'>
        ...
        <div className='h-1/2 flex justify-around items-center bg-neutral-200'>
          <StyledText>Home</StyledText>
          <StyledText>About</StyledText>
          <StyledText>Service</StyledText>
          <StyledText>Pages</StyledText>
      ...
      <div className='md:hidden grid content-center w-[30%] h-full'>
