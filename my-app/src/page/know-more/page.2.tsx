...
const PageTwo: React.FC = () => {
    return <div className="h-full lg:flex py-[100px]">
        <div className="lg:w-1/2">
            <img src="https://hornokplease.ae/img/services/furniture-movers-for-corporate.jpg" alt="" className="w-[80%] ml-[10%] md:mt-20" />
        </div>
        <div className="lg:w-1/2 pt-20 text-start px-5 md:px-10">
            <p className="text-2xl font-[800] underline underline-offset-8">Furniture Movers</p>
            <p className="leading-7 mt-5">

                Working with many Furniture companies to deliver and assemble there customer furniture. We are best furniture movers in Dubai.
